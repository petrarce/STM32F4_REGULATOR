...
#define PLL_M      8  //was 25 sna4ala popadaem na M delim nashu vhodnuyu taktovuyu na /M 4tb vhodnaya bula 1-2MHz (esli delim na 4 budet imenno 2MHz)
											// esli postavim 8 a ne 4 to N skolko postavim iz 192-432 stolko srazu i polu4im
											// M from 2 to 63  (ot 2 to 63 delim na 8 i dolgnu polu4it ot 1 do 2 MHz) toest 25/8 o4 malo a 8/8 norm
...
#define PLL_Q      7      																//datasheet f406VG 223str opisanie Q M R P N etc
...
#define PLL_N      336				//was 360 mnogutel VCO dlgno legat 192-432MHz  2MHz /M * 200 = 400MHz   N from 192 to 432(223)
/* SYSCLK = PLL_VCO / PLL_P */
#define PLL_P      2	m h	//P = 2,4,6,8 was 2 s ego pomoshyu  mu dolgnu polu4it final freq ne bolshe 168MHz (shas 400 mogno delit na 2 4 6 8)/4 = 100MHz
#endif /* STM32F40_41xxx || STM32F427_437x || STM32F429_439xx || STM32F446xx */    // v SystemCoreClock esli zapishem 100MHz vmesto 48 dolgno rabotat
...
/** @addtogroup STM32F4xx_System_Private_Variables
  ...
  */
  ...
  uint32_t SystemCoreClock = 48000000; // was 168000000 
